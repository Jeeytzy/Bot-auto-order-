...
class TigerSMSProvider extends BaseProvider {
    constructor(config) {
        super(config);
    }
    ...
    async getCountries() {
        try {
            const response = await axios.get(`${this.baseUrl}/stubs/handler_api.php`, {
                params: {
                    api_key: this.apiKey,
                    action: 'getCountries'
                }
...
module.exports = TigerSMSProvider;